...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '258a6407321e80bd8590da5427cd9657,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Mahsing', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '做事只有开头😂', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.mahsing.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon (1).ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
